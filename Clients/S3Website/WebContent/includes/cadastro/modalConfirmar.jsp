...
<form id="modalConfirmacao">
	...
	<div class="form-group row">
		<label class="col-sm-1 col-form-label"><img id="icon"
			src="_img/user.png" alt="user_icon"></img></label>
		<div class="col-sm-11">
			<input type="email" id="emailConf" class="form-control"
				placeholder="E-mail" name="email" autocomplete="off" required>
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-1 col-form-label"><img id="icon"
			src="_img/key.png" alt="key_icon"></img></label>
		<div class="col-sm-11">
			<input type="password" id="senhaConf" class="form-control"
